...
while cv2.waitKey(1)!=30:
	...
	while distance2<=10:
		try:
			...
			message = """\
			Subject: WARNING: TRASG CAN IS FULL\n"""+"\n"+"So luong chai nhua: "+str(n_bottle)+"\nSo qua 5 chai da phat: "+str(score_gift1)+"\
			"+"\nSo qua 10 chai da phat: "+ str(score_gift2)
